...
const petStories: Record<PetName, { name: string; role: string; story: string; image: string }> = {
  ...
  pirat: {
    ...
    story:
      "Когда я был молодым, в одной собачьей истории я потерял половину левого уха — поэтому меня легко узнать. Я знаю дорогу к ручью и лесные тропинки. Рядом сохранились развалины шахты 1930-х годов: смотреть на них можно только со взрослыми, не подходя близко и не заходя внутрь. Настоящий следопыт всегда помнит о безопасности!",
  },
  barsik: {
    name: "Барсик",
